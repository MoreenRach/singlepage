...
import refFood from "../../assets/food.jpg"

const Movie5 = () => {
  return (
    <div class="grid-container5">
      <div class="item1">Februar</div>
      ...
      <div class="item5">
        ...
        <p class="card-text">
          ...
          the basis of world nutrition.</p>
        <p class="card-text">
          ...
          for the future will be presented impartially.</p>
        <p class="card-text">
